...
ALTER TABLE "FormConfig" ADD COLUMN IF NOT EXISTS "showProgressBar" BOOLEAN DEFAULT true;
ALTER TABLE "FormConfig" ADD COLUMN IF NOT EXISTS "storefrontHeading" TEXT;
ALTER TABLE "FormConfig" ADD COLUMN IF NOT EXISTS "storefrontDescription" TEXT;
...
ALTER TABLE "FormConfig" ALTER COLUMN "showProgressBar" SET DEFAULT true;
...
ALTER TABLE "FormConfig" ALTER COLUMN "showProgressBar" SET NOT NULL;
