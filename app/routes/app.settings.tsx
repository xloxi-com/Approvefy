...
function SettingsPage({ data }: { data: SettingsPageLoaderData }) {
    ...
    useProgrammaticSaveBar(SETTINGS_SAVE_BAR_ID, hasUnsavedChanges, isSaving);
    ...
    return (
        <>
            <AppSaveBar
                id={SETTINGS_SAVE_BAR_ID}
                isSaving={isSaving}
                onSave={() => settingsFormRef.current?.requestSubmit()}
                onDiscard={() => {
                    flushSync(() => {
                        handleDiscard();
                    });
                        ...
                        {activeMainSectionId === "email-setting" && (
                            ...
                            <SectionCard title={emailSettingSubIndex === 0 ? "SMTP" : "Email templates"}>
                                ...
                                <EmailTemplatesPanel
                                    ...
                                    setSettings={setCustomerApprovalSettings}
                                    selectedApprovalPresetId={selectedApprovalPresetId}
                                    setSelectedApprovalPresetId={setSelectedApprovalPresetId}
                                    selectedRejectionPresetId={selectedRejectionPresetId}
                                    setSelectedRejectionPresetId={setSelectedRejectionPresetId}
                                    ...
                                    setRejectedSectionOpen={setRejectedSectionOpen}
                                    approvalTemplateModalOpen={approvalTemplatePopoverActive}
                                    setApprovalTemplateModalOpen={setApprovalTemplatePopoverActive}
                                    rejectionTemplateModalOpen={rejectionTemplatePopoverActive}
                                    setRejectionTemplateModalOpen={setRejectionTemplatePopoverActive}
                                    shop={{
                                        storeName: initialStoreName ?? "Store",
                                        storeEmail: initialStoreEmail ?? "",
                                        storeDomain: initialStoreDomain ?? "",
                                        storeLogoUrl: initialStoreLogoUrl,
                                    }}
                                    richTextEditor={(props) => <DeferredRichTextEditor {...props} />}
                                />
                                        )}
                            </SectionCard>
                            </div>
