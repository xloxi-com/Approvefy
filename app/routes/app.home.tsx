      ...
      <Page title="Approvefy" fullWidth>
        ...
        <BlockStack gap="200" inlineAlign="start">
          <InlineStack gap="100" wrap>
            <Button size="slim" variant="primary" onClick={() => navigate("/app/home")}>
              Home
            </Button>
              ...
              <BlockStack gap="400">
                <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <Text as="p" fontWeight="semibold">Theme app extension (App embed)</Text>
                    <Text as="p" variant="bodySm" tone="subdued">
                      Approvefy uses a theme app extension. Open the theme editor, go to <strong>App embeds</strong>, turn on <strong>Approvefy</strong>, then click the embed to open its settings and enable <strong>Enable custom registration form</strong>. Save the theme. The form only loads on the customer registration page after both steps are on.
                    </Text>
        ...
        {setupTasksComplete < 2 ? (
          <LegacyCard sectioned>
            <BlockStack gap="300">
              ...
              <Text as="p" variant="bodySm" tone="subdued">
                After you enable the Approvefy app embed, turn on <strong>Enable custom registration form</strong> in the embed settings, create a form, and configure settings, click <strong>Customers</strong> in the nav or the button below to view the list.
              </Text>
            </BlockStack>
          </LegacyCard>
        ) : (
