...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  // Match Shopify app template: embedded installs include `shop` — load `/app` so
  // `authenticate.admin` can run the session-token bounce and token exchange.
  // Sending merchants to `/auth` first breaks that flow and can yield 401 / blank iframe.
